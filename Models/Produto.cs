...
namespace KitsGade.Models
{
    ...
    public class Produto
    {
        ...
        [StringLength(80, MinimumLength = 10, ErrorMessage ="O {0} deve ter no mínimo {1} é no máximo {2} caracteres")]
        public string Nome { get; set; }
        [Required(ErrorMessage = "A descrição do produto deve ser informada")]
        [Display(Name = "Descrição do Produto")]
        [MinLength(20, ErrorMessage ="Deve ter no mínimo {1} caracteres")]
